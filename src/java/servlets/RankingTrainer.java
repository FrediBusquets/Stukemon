 ...
 * @author USER
 */
@WebServlet(name = "RankingTrainer", urlPatterns = {"/RankingTrainer"})
public class RankingTrainer extends HttpServlet {
    @EJB
    StukemonEJB miEjb;
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet RankingTrainer</title>");            
            out.println("</head>");
            out.println("<body>");
           ...
           out.println("</tr>");
            for (Trainer trainer : miEjb.selectAllTrainersOrder()) {               
            out.println("<tr>");
